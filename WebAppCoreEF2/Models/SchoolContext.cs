...
namespace WebAppCoreEF2.Models
{
    public partial class SchoolContext : DbContext
    {
        ...
        public DbQuery<Vw_ExtendedPerson> vw_ExtendedPeople { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-391R7HE2;Database=School;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Query<Vw_ExtendedPerson>().ToView("Vw_ExtendedPerson","dbo");
        }
    }
}
